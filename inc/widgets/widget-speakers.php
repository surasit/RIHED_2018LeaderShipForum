 ...
 * Description: Add speakers on home page
 * Author: Victor Tihai
 * Version: 1.0
...
class wplook_speakers_widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			__( 'WPlook Speakers (Home page)', 'event-wpl' ),
			array( 'description' => __( 'A widget for displaying Speakers on Home Page', 'event-wpl' ), )
		);
	}
	...
	public function form( $instance ) {
		...
		?>
			...
			<p>
				<label for="<?php echo $this->get_field_id('nr_posts'); ?>"> <?php _e('Number of Speakers:', 'event-wpl'); ?> </label>
				...
				<p style="font-size: 10px; color: #999; margin: -10px 0 0 0px; padding: 0px;"> <?php _e('Number of Speakers you want to display', 'event-wpl'); ?></p>
			</p>
			...
			<p>
				<label for="<?php echo $this->get_field_id('read_more_link'); ?>"> <?php _e('URL to all Speakers:', 'event-wpl'); ?> </label>
				...
				<p style="font-size: 10px; color: #999; margin: -10px 0 0 0px; padding: 0px;"> <?php _e('View all speakers URL', 'event-wpl'); ?></p>
			</p>

			<br />
			<p style="font-size: 10px; color: #999; margin: -10px 0 0 0px; padding: 0px;"> <?php _e('The ID of this widget is: <strong>speakers</strong>', 'event-wpl'); ?></p>
			<br />
					...
					<div class="row">
						...
						<?php if ($read_more_link) { ?>
							...
							<div class="col-sm-12 col-md-12">
								<div class="button button-icon pull-right"><a href="<?php echo $read_more_link ?>" title="<?php _e('View all Speakers', 'event-wpl'); ?>" ><?php _e('View all Speakers', 'event-wpl'); ?></a> <span class="fa fa-chevron-down"></span></div>
							</div>
						<?php } ?>
					</div>
			</section>
